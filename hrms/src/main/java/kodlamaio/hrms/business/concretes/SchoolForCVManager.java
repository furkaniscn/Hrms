...
public class SchoolForCVManager implements SchoolForCVService {
	...
	@Override
	public Result add(SchoolForCV schollForCV) {
		this.schoolForCVDao.save(schollForCV);
	...
	public DataResult<SchoolForCV> getById(int id) {
		return new SuccessDataResult<SchoolForCV>
		(this.schoolForCVDao.getById(id));
	}

	@Override
	public DataResult<List<SchoolForCV>> getAllByJobseekerId(int id) {
		return new SuccessDataResult<List<SchoolForCV>>
		(this.schoolForCVDao.getAllByJobseeker_id(id));
	}
	...
	public DataResult<List<SchoolForCV>> getAllByJobseekerIdOrderByEndAtDesc(int id) {
		return new SuccessDataResult<List<SchoolForCV>>
		(this.schoolForCVDao.getAllByJobseeker_idOrderByEndAtDesc(id));
	}
